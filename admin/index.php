...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">Mangrani HOMEPAGE</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
         ...
         echo '<script>alert("we were unable to match the user ID and password you entered. please check your entries and try again") </script>' ;
      }
   }
?>
