...
<head>
    ...
    <title>RESERVATION Mangrani HOTEL</title>
    <!-- Bootstrap Styles-->
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="nation"  value="Sri Lankan" checked="">Pakistani
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="nation"  value="Non Sri Lankan ">Non Pakistani 
                                            </label>
                                ...
                                $countries = array("Afghanistan","America");
